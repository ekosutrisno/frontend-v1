<template>
  <div class="relative">
    ...
    >
      <div class="text-sm font-semibold mr-3 group-hover:text-green-secondary">{{this.$route.path.split('/', 2)[1]}}</div>
      <div class="w-8 h-8 rounded-full overflow-hidden">
        <img
          ...
          alt="avatar"
          class="h-full w-full object-cover opacity-75 group-hover:opacity-100"
        >
      </div>
      <svg
        fill="currentColor"
