<template>
  <div class="mx-auto pb-5">
    ...
    <div class="flex nl-transition flex-col mt-5 p-5 lg:mr-5 h-auto space-y-4 dark:shadow-lg rounded-lg border border-gray-400 dark:border-gray-800">
      ...
      <div class="flex items-center justify-start">
        <div class="flex items-start mb-10">
          ...
          <div class="block">
            ...
            <h1 class="nama font-medium text-sm">Created: {{employee.createdOn}} | Last Modifed: {{employee.modifedOn}}</h1>
          </div>
        </div>
      </div>
      ...
      <div class="flex flex-col">
        ...
        <div class="inline-flex items-center space-x-3">
          ...
          <h1
            v-if="employee.gender ==true"
            class="nama font-medium text-lg"
          > : Laki-laki</h1>
          <h1
            v-else-if="employee.gender ==false"
            class="nama font-medium text-lg"
          > : Perempuan</h1>
        </div>
        <div class="inline-flex items-center space-x-3">
    ...
    <div class="flex flex-col mt-5 p-5 lg:mr-5 h-auto space-y-4 dark:shadow-lg rounded-lg border border-gray-400 dark:border-gray-800">
      <div class="flex items-start justify-between">
        <div class="flex space-x-2 items-center justify-between">
          <span class="text-green-secondary font-semibold"> <i class="fa fa-paperclip"></i> Address</span>
        </div>
      </div>
      <div class="flex flex-col">
        <div class="inline-flex items-center space-x-3">
      ...
      <div class="flex flex-col">
        <div class="inline-flex items-center space-x-3">
          ...
          <h1
            v-if="employee.kelurahan1"
            class="nama font-medium text-lg"
          >: {{employee.kelurahan1}}</h1>
          <h1
            v-else
            class="nama font-medium text-lg"
          >: -</h1>
        ...
        <div class="inline-flex items-center space-x-3">
          ...
          <h1
            v-if="employee.kelurahan2"
            class="nama font-medium text-lg"
          >: {{employee.kelurahan2}}</h1>
          <h1
            v-else
            class="nama font-medium text-lg"
          >: -</h1>
        ...
        <div class="inline-flex items-center space-x-3">
          ...
          <h1
            v-if="employee.kecamatan1"
            class="nama font-medium text-lg"
          >: {{employee.kecamatan1}}</h1>
          <h1
            v-else
            class="nama font-medium text-lg"
          >: -</h1>
        ...
        <div class="inline-flex items-center space-x-3">
          ...
          <h1
            v-if="employee.kecamatan2"
            class="nama font-medium text-lg"
          >: {{employee.kecamatan2}}</h1>
          <h1
            v-else
            class="nama font-medium text-lg"
          >: -</h1>
